  ...
  <div class="container">
    ...
    <ul>
      <li v-for="(task, index) in filteredTasks" :key="index">
        <input type="checkbox" v-model="task.done" @change="saveTasksToStorage" />
...
export default {
  ...
  computed: {
    filteredTasks() {
      return this.showCompleted ? this.tasks : this.tasks.filter((task) => !task.done);
    },
  },
};
</script>
...
.container h1 {
  font-style: Arial sans-serif Black ;
  font-size: 32px;
  color: #333;
}
